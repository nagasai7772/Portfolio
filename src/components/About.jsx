      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
        ...
        >
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-300 mb-6 sm:mb-8 leading-relaxed">
             Motivated and detail-oriented MERN Stack Developer with hands-on project experience in developing full-stack web applications using MongoDB, Express.js, React.js, and Node.js. Skilled in building scalable backend services, integrating RESTful APIs, and designing responsive, user-friendly interfaces. Quick learner with strong problem-solving skills and a passion for clean, efficient code. Eager to contribute to collaborative development teams and grow as a full-stack developer in a dynamic work environment.
          </p>
          <footer>
            <button
